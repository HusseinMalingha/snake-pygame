...
class Apple:
    ...
    def move(self):
        self.x = randint(0,15)*SIZE
        self.y = randint(0,15)*SIZE
...
class Game:
    ...
    def show_game_over(self):
        ...
        line1 = font.render(f"Game Over Your is Score: {self.snake.length}", True, (255,255,255))
